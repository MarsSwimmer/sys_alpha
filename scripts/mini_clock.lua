...
seconds_ring_base_color  = {0xFFFFFF, 0.2}, -- base color
seconds_ring_fill_color  = {0xFFFFFF, 0.6}, -- fill color
seconds_ring_fill_colorS = {0xFFFFFF, 0.6},

-- Main settings
xc = 85, -- centre of the clock
yc = 320,
R  = 85,  -- default radius of the clock
RH = 45,  -- outher radius for hours fill ring
RM = 65,  -- outer radius for minutes fill ring
...
fill_color       = {0xea9d34, 1},   -- fill color for hour+minutes ring
fill_colorS      = {0x0076E8, 1},   -- fill color for seconds ring
